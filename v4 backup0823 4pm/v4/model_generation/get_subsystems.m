...
%       system, NOT include sub systems inside a subsystem if iput args < 2
%         or opt = 0
%       if opt = 1 as 2nd arg, get all sub models names
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
%Example Run: get_subsystems()
%Example Run: get_subsystems('test_mdl/abc') or  get_subsystems('test_mdl/gcs') 
%Example Run: get_subsystems('test_mdl/abc',1])
