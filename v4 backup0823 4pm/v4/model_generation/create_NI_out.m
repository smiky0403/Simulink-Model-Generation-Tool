function create_NI_out(dir, names_blk, varargin)
%--------------------------------------------------------------------------
...
%Example Run: create_NI_out('test_mdl', {'x', 'y', 'z', 'u', 'v', 'w//s'})
%Example Run: create_NI_out('test_mdl', {'x', 'y', 'z', 'u', 'v', 'w//s'}, [1,3,5,7,10,14])
...
for i = 1: length(names_blk)
    ...
    if isempty( regexp(input, '/', 'match')  )
        ...
        add_block('NIVeriStandBlocks/NIVeriStand Out1', cur_cnst_path, 'Position',  pos_cnst + ...
       ...
       % --------Patch When name contain '/'---------------------
        ...
        h = add_block('NIVeriStandBlocks/NIVeriStand Out1', cur_cnst_path, 'Position',  pos_cnst + ...
        [0,(pos_i - 1)* pos_cnst_y_div, 0,(pos_i - 1)* pos_cnst_y_div]);
